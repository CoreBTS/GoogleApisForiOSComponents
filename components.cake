...
Artifact MLKIT_CORE_ARTIFACT = new Artifact("MLKit.Core", "6.0.0", "12.0", ComponentGroup.MLKit, csprojName: "Core");
Artifact MLKIT_TEXT_RECOGNITION = new Artifact("MLKit.TextRecognition", "4.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognition");
Artifact MLKIT_VISION = new Artifact("MLKit.Vision", "7.0.0", "12.0", ComponentGroup.MLKit, csprojName: "Vision");
Artifact MLKIT_TEXT_RECOGNITION_LATIN = new Artifact("MLKit.TextRecognition.Latin", "3.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognitionLatin");
Artifact MLKIT_TEXT_RECOGNITION_CHINESE = new Artifact("MLKit.TextRecognition.Chinese", "3.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognitionChinese");
Artifact MLKIT_TEXT_RECOGNITION_DEVANAGARI = new Artifact("MLKit.TextRecognition.Devanagari", "3.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognitionDevanagari");
Artifact MLKIT_TEXT_RECOGNITION_JAPANESE = new Artifact("MLKit.TextRecognition.Japanese", "3.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognitionJapanese");
Artifact MLKIT_TEXT_RECOGNITION_KOREAN = new Artifact("MLKit.TextRecognition.Korean", "3.0.0", "10.0", ComponentGroup.MLKit, csprojName: "TextRecognitionKorean");
Artifact MLKIT_FACE_DETECTION = new Artifact("MLKit.FaceDetection", "5.0.0", "10.0", ComponentGroup.MLKit, csprojName: "FaceDetection");
...
Artifact MLKIT_DIGITAL_INK_RECOGNITION = new Artifact("MLKit.DigitalInkRecognition", "5.0.0", "10.0", ComponentGroup.MLKit, csprojName: "DigitalInkRecognition");
Artifact MLKIT_IMAGE_LABELING = new Artifact("MLKit.ImageLabeling", "5.0.0", "10.0", ComponentGroup.MLKit, csprojName: "ImageLabeling");
Artifact MLKIT_OBJECT_DETECTION = new Artifact("MLKit.ObjectDetection", "5.0.0", "10.0", ComponentGroup.MLKit, csprojName: "ObjectDetection");
