...
namespace MLKit.TextRecognition
{
	...
	interface TextRecognizer
	{
		...
		void ProcessImage(CompatibleImage image, TextRecognitionCallback completion);
		...
		[return: NullAllowed]
		VisionText ResultsInImage(CompatibleImage image, [NullAllowed] out NSError error);
	}
}
